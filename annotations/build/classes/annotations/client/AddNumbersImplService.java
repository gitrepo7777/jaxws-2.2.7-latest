 ...
 * 
 */
@WebServiceClient(name = "AddNumbersImplService", targetNamespace = "http://server.annotations/", wsdlLocation = "http://localhost:8080/metro-annotations/addnumbers?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/metro-annotations/addnumbers?wsdl");
