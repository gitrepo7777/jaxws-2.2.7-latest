 ...
 * generated in the annotations.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddNumbersException_QNAME = new QName("http://duke.example.org", "AddNumbersException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: annotations.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://duke.example.org", name = "AddNumbersException")
